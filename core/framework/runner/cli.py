...
def register_commands(subparsers: argparse._SubParsersAction) -> None:
    ...
    open_parser = subparsers.add_parser(
        ...
        description="Shortcut for 'nexa serve --open'. "
...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    if getattr(args, "tui", False):
        from framework.tui.app import NexaTUI
...
def _launch_agent_tui(
    ...
    async def run_with_tui():
        ...
        app = NexaTUI(runner._agent_runtime)
        try:
            await app.run_async()
        except Exception as e:
            import traceback
...
def cmd_setup_credentials(args: argparse.Namespace) -> int:
    ...
    if agent_path:
        ...
        print("Usage: nexa setup-credentials <agent_path>")
        print()
        print("Examples:")
        print("  nexa setup-credentials exports/my-agent")
        print("  nexa setup-credentials examples/templates/deep_research_agent")
        return 1
