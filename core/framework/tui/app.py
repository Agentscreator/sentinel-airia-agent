...
class NexaTUI(App):
    ...
    async def _load_judge_and_queen(self, storage_path) -> None:
        ...
        try:
            ...
            queen_runtime = Runtime(nexa_home / "queen")
        ...
        if not session.missing:
            ...
            if "not connected" in error_msg or "Aden" in error_msg:
                ...
                self.notify(
                    ...
                    "detected. Run 'nexa setup-credentials' "
                    "from the terminal.",
                    severity="error",
                    timeout=10,
                )
    ...
    def _show_build_edit_message(self) -> None:
        ...
        self.notify(
            "To build or edit agents, use 'nexa build' from the terminal "
            "or run Claude Code with the /nexa skill.",
            severity="information",
            timeout=10,
        )
