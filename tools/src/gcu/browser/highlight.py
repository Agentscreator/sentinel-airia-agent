...
Configure via environment variables:
    NEXA_BROWSER_HIGHLIGHTS=0   Disable entirely
    NEXA_HIGHLIGHT_COLOR        Override color (default: #FAC43B)
    NEXA_HIGHLIGHT_DURATION_MS  Override visible duration (default: 600)
"""
...
_ENABLED = os.environ.get("NEXA_BROWSER_HIGHLIGHTS", "1") != "0"
_COLOR = os.environ.get("NEXA_HIGHLIGHT_COLOR", "#FAC43B")
_DURATION_MS = int(os.environ.get("NEXA_HIGHLIGHT_DURATION_MS", "1500"))
